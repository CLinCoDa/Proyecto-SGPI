    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_ult_ingreso', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField(blank=True, null=True)),
                ('permisos', models.ManyToManyField(related_name='roles', to='core.permiso')),
            ],
        ),
        migrations.CreateModel(
            name='AsignacionRol',
        ...
        migrations.AddField(
            model_name='usuario',
            name='roles',
            field=models.ManyToManyField(related_name='usuarios', through='core.AsignacionRol', to='core.rol'),
        ),
    ]
